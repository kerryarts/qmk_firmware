...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [CL_FUNC] = LAYOUT_65_ansi(
        ...
        CKC_LL_1, KC_P4, KC_P5, KC_P6, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_SLCK, DYN_REC_START2, DYN_MACRO_PLAY2, KC_MPLY, KC_VOLD,
        KC_TRNS, KC_P1, KC_P2, KC_P3, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MRWD, KC_VOLU, KC_MFFD,
        KC_TRNS, KC_APP, KC_TRNS, KC_P0, KC_NO, CKC_LL_1, KC_NO, KC_MPRV, KC_VOLD, KC_MNXT),
    ...
    [CL_SYS] = LAYOUT_65_ansi(
        ...
        KC_NO, KC_NO, CKC_WPM_TOG, EEP_RST, RESET, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
